...
public class PalmTrapdoorBlock extends HyventureModModElements.ModElement {
	@ObjectHolder("hyventure_mod:palm_trapdoor")
	public static final Block block = null;
	public PalmTrapdoorBlock(HyventureModModElements instance) {
		super(instance, 16);
	}
