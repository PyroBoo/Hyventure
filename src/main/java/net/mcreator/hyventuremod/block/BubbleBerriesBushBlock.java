...
import net.mcreator.hyventuremod.procedures.BubbleBerriesBushMobplayerCollidesWithPlantProcedure;
import net.mcreator.hyventuremod.itemgroup.HyventureTabItemGroup;
import net.mcreator.hyventuremod.item.BubbleBerriesItem;
...
public class BubbleBerriesBushBlock extends HyventureModModElements.ModElement {
	@ObjectHolder("hyventure_mod:bubble_berries_bush")
	public static final Block block = null;
	public BubbleBerriesBushBlock(HyventureModModElements instance) {
		super(instance, 28);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("hyventure_mod:bubble_forest")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("bubble_berries_bush");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BubbleBerriesItem.block, (int) (2)));
		}
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				BubbleBerriesBushMobplayerCollidesWithPlantProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
