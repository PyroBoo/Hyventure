...
import net.mcreator.hyventuremod.procedures.BubblegrassSpreadingProcedure;
...
public class BubblegrassBlock extends HyventureModModElements.ModElement {
	@ObjectHolder("hyventure_mod:bubblegrass")
	public static final Block block = null;
	public BubblegrassBlock(HyventureModModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BubbledirtBlock.block, (int) (1)));
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BubblegrassSpreadingProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
