...
public class BubblewoodStairsBlock extends HyventureModModElements.ModElement {
	@ObjectHolder("hyventure_mod:bubblewood_stairs")
	public static final Block block = null;
	public BubblewoodStairsBlock(HyventureModModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bubblewood_stairs");
		}
