...
public class BubblewoodLogBlock extends HyventureModModElements.ModElement {
	@ObjectHolder("hyventure_mod:bubblewood_log")
	public static final Block block = null;
	public BubblewoodLogBlock(HyventureModModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("bubblewood_log");
		}
