...
import net.mcreator.hyventuremod.item.RiceItem;
...
public class WildRiceBlock extends HyventureModModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RiceItem.block, (int) (3)));
		}
