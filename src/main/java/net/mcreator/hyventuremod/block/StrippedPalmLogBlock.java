...
public class StrippedPalmLogBlock extends HyventureModModElements.ModElement {
	@ObjectHolder("hyventure_mod:stripped_palm_log")
	public static final Block block = null;
	public StrippedPalmLogBlock(HyventureModModElements instance) {
		super(instance, 26);
	}
