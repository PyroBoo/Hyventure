...
public class StrippedBubblewoodLogBlock extends HyventureModModElements.ModElement {
	@ObjectHolder("hyventure_mod:stripped_bubblewood_log")
	public static final Block block = null;
	public StrippedBubblewoodLogBlock(HyventureModModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_bubblewood_log");
		}
