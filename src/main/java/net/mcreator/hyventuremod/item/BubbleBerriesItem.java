...
public class BubbleBerriesItem extends HyventureModModElements.ModElement {
	@ObjectHolder("hyventure_mod:bubble_berries")
	public static final Item block = null;
	public BubbleBerriesItem(HyventureModModElements instance) {
		super(instance, 29);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("bubble_berries");
		}
